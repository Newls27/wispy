...
Future<void> saveScore({
  ...
  const String googleScriptUrl =
      'https://script.google.com/macros/s/AKfycbzNdPPUEarQ2SqlyfBsoGxh4QDlhOmnfJtUNUr6RImyzf_QgevpYbAcBFIA2beqFzoT4w/exec';
...
class _QuizPageState extends State<QuizPage> {
  ...
  Future<void> nextQuestion() async {
    if (currentQuestion < questions.length - 1) {
      ...
      // Prevent the final button from submitting the same score twice
      // if it is clicked more than once while the request is finishing.
